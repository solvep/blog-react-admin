                  ...
                  return (
                    ...
                    (t.handleOk = function() {
                      var e = t.props.dispatch,
                        a = { name: t.state.name, desc: t.state.desc };
                      new Promise(function(t) {
                        e({ type: 'category/addCategory', payload: { resolve: t, params: a } });
                      }).then(function(e) {
                        0 === e.code
                          ? (f.default.success({ message: e.message }),
                            t.setState({ visible: !1, name: '', desc: '' }),
                    ...
                    (t.handleSearch = function() {
                      ...
                      new Promise(function(t) {
                        e({ type: 'category/queryCategory', payload: { resolve: t, params: a } });
                      }).then(function(e) {
                        0 === e.code
                    ...
                    (t.handleDelete = function(e, a) {
                      ...
                      new Promise(function(e) {
                        n({ type: 'category/delCategory', payload: { resolve: e, params: l } });
                      }).then(function(e) {
                        0 === e.code
                          ? (f.default.success({ message: e.message }),
                            t.handleSearch(t.state.pageNum, t.state.pageSize))
                    ...
                    (t.handleChange = t.handleChange.bind((0, y.default)(t))),
                    (t.handleDescChange = t.handleDescChange.bind((0, y.default)(t))),
                    (t.handleChangeKeyword = t.handleChangeKeyword.bind((0, y.default)(t))),
                    (t.handleOk = t.handleOk.bind((0, y.default)(t))),
                    (t.handleDelete = t.handleDelete.bind((0, y.default)(t))),
                    (t.showModal = t.showModal.bind((0, y.default)(t))),
                    (t.handleCancel = t.handleCancel.bind((0, y.default)(t))),
                    (t.handleSearch = t.handleSearch.bind((0, y.default)(t))),
                    t
                  );
                }
                return (
